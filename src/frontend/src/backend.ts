...
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: number, arg1: string, arg2: string): Promise<Transaction> {
        if (this.processError) {
            try {
    ...
    async analyzeExpenses(): Promise<ExpenseAnalysis> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeExpenses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInvestmentHistory(): Promise<Array<RoundupHistory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInvestmentHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWalletSummary(): Promise<InvestmentWallet> {
        if (this.processError) {
            try {
